    ...
    >
      ...
      <div className="p-3">
        ...
        {image.material && image.material !== 'Unknown' && (
          <p className="text-xs text-gray-500 truncate">{image.material}</p>
        )}
        {colors.length > 0 && (
          <div className="flex flex-wrap gap-1 mt-1">
            ...
            {colors.length > 3 && <span className="text-xs text-gray-400">+{colors.length - 3}</span>}
          </div>
        )}
        {image.annotations?.length > 0 && (
          <div className="mt-1 flex items-center gap-1">
            ...
            <span className="text-xs text-amber-600">{image.annotations.length} note{image.annotations.length !== 1 ? 's' : ''}</span>
          </div>
        )}
      </div>
    </Link>
